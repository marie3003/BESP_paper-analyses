...
REL_PATH=$(realpath --relative-to=/cluster/work/stadler/beckermar/BESP_paper-analyses/pop_size_simulations/simulation_results "$XML_FILE")
...
beast -overwrite -seed 43 -working "$XML_FILE" -prefix "$OUT_XML_BASE"
