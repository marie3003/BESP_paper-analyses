...
POP_MODELS = ["bottleneck20", "bottleneck50", "bottleneck100", "bottleneck200", "bottlenecklate", "bottlenecklatesampling"]
#NREPLICATES    = 100
NREPLICATES = 10
...
def get_burnin(wildcards):
    ...
    if wildcards.sampling == "independenthomochronous":
        if wildcards.popmodel in ("bottleneck", "bottleneck20", "bottleneck50", "bottleneck100", "bottleneck200", "bottlenecklate", "bottlenecklatesampling"):
