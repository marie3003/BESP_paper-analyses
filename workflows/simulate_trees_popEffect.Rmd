...
Instead use:
awk '{print > ("uniform_" NR-1".nwk")}' ../../BESP_paper-analyses/results/pop_size_simulations/linear_constant/uniform/uniform.trees

for file in uniform_*.nwk; do
    base=$(basename "$file" .nwk)
    ./seq-gen -mHKY -f0.25,0.25,0.25,0.25 -l450 -s4.6e-4 -n1 < "$file" > ../../BESP_paper-analyses/results/pop_size_simulations/linear_constant/uniform/"$base".fasta
    rm "$file"
done
