...
The `check_mcmc.sh` script select all trees that have a sufficiently high ESS (above $200$) considering the combined log and trees files. It then creates summary trees using treeannotator. 
